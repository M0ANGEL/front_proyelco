...
import {
  ...
  updatePTO,
  crearPTO,
} from "@/services/documentos/ptoAPI";
...
export const FormPTO = () => {
  ...
  const [documentoInfo, setDocumentoInfo] =
    useState<ProductoTerminadoCabecera>();
  ...
  const summaryProps: SummaryProps = {
    firstCell: { index: 0, colSpan: 3, align: "right" },
