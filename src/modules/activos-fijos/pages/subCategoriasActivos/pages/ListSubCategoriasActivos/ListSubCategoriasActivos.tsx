...
import { DeleteActiSubCategoria, getActiSubCategorias } from "@/services/activosFijos/SubCategoriasAPI";
...
export const ListSubCategoriasActivos = () => {
  ...
  const fetchCategorias = () => {
    getActiSubCategorias().then(({ data: { data } }) => {
  ...
  return (
    <StyledCard
      title={"Lista de SubCategorias Activos Fijos"}
      extra={
