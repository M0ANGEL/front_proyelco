...
export const ListTrasladosActivosPendientesAdmin = () => {
  ...
  const handleAccept = async (key: React.Key) => {
    ...
    aceptarTrasladoAdmin(id_activo, userId)
      .then((response) => {
  ...
  const columns: ColumnsType<DataType> = [
...

    {
      ...
      key: "activo",
      render: (record: any) =>
        `${record.id || "na"} - ${record.nombre || "Sin nombre"}`,
    },
    ...
    },
    {
      ...
      render: (_, record) => {
        return (
          <Space>
            <Tooltip title="Aprobar traslado ">
              <Button
