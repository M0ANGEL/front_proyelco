...
export const ModalConfirmacion = ({
  ...
  const handleConfirmar = async () => {
    try {
      ...
      // Validar que haya al menos un archivo si estado == "2"
      if (estado == "2" && files.length === 0) {
      ...
      // ✅ IMPORTANTE: Usar la fecha del formulario (la que selecciona el usuario)
      if (values.fecha_confirmacion) {
        ...
        // Si no hay fecha seleccionada (no debería pasar por validación), usar fecha actual
  ...
  return (
    <Modal
      ...
      footer={[
        ...
        >
          {estado == "2" ? "Subir Archivos" : "Confirmar Actividad"}
        </Button>,
      ]}
    >
      <Form 
      ...
      >
        {/* Campo de fecha - Siempre visible cuando no está en estado 2 */}
        {estado != "2" && (
          <Form.Item
        ...
        <Form.Item
          label={
            <span>
              {estado == "2" ? "Archivos requeridos" : "Archivos adicionales (opcional)"}
            </span>
          }
