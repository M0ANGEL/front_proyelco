...
const Dashboard: React.FC = () => {
  ...
  const loadDashboardData = async () => {
    try {
      ...
      /* 
      title: titulo
      icon: icono de la carta, los traigo de react icon
      value: el valor que se trae del backend
      link: por si hay un valor diferente a 0 puede dar click e ir a ese link
      permiso: true 
      bgColor: es el color por medio del index del array de colores mas arriba
      */
  ...
  if (error) {
    return (
      <div>
        <Title style={{ marginLeft: "20px" }} level={4}>
          Dashboard Principal
        </Title>
                  ...
                  >
                    <Card
                      ...
                      style={{
                        ...
                        cursor:
                          link && value > 0 && permiso ? "pointer" : "auto",
                        borderRadius: "8px",
