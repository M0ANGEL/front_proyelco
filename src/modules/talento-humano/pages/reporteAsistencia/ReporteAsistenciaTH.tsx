...
// // import { Button, Input, Tag, Tooltip, Typography, Row, Col, Statistic, Card } from "antd";
// // import Table, { ColumnsType } from "antd/es/table";
// // import { SearchBar } from "@/modules/gestion-empresas/pages/empresas/pages/ListEmpresas/styled";
// // import { getReporteAsistenciasTH } from "@/services/talento-humano/reporteAPI";
...
// //     return Object.values(statsMap).sort((a, b) => b.totalActivos - a.totalActivos);
// //   };

// //   const fetchAsistencias = () => {
// //     getReporteAsistenciasTH().then(({ data: { data } }) => {
...
// //       key: "fecha_ingreso",
// //       sorter: (a, b) => {
// //         return dayjs(b.fecha_ingreso, 'DD-MM-YYYY').unix() - dayjs(a.fecha_ingreso, 'DD-MM-YYYY').unix();
// //       },
...
// //       render: (tipo) => (
// //         <Tag color={tipo.includes('Proyelco') ? 'blue' : 'orange'}>
// //           {tipo}
// //         </Tag>
// //       ),
// //     },
...
// //   const totalActivos = dataSource.filter(item => item.estado_asistencia === 'activa').length;
...
// //         <Card 
// //           title="Personas Activas por Contratista" 
// //           style={{ marginBottom: 16 }}
// //           size="small"
// //         >
// //           <Row gutter={[16, 16]}>
// //             {contratistasStats.map((contratista, index) => (
// //               <Col xs={24} sm={12} md={8} lg={6} key={contratista.nombre}>
// //                 <Card size="small">
// //                   <Statistic
// //                     title={contratista.nombre}
// //                     value={contratista.totalActivos}
// //                     valueStyle={{ 
// //                       color: contratista.totalActivos > 0 ? '#3f8600' : '#cf1322',
// //                       fontSize: '24px'
// //                     }}
// //                     prefix={<Tag color={contratista.totalActivos > 0 ? "green" : "red"}>●</Tag>}
// //                     suffix="activas"
// //                   />
// //                 </Card>
// //               </Col>
...
// //               Total de personas activas: <Tag color="green" style={{ fontSize: '16px' }}>{totalActivos}</Tag>
// //             </Text>
// //           </div>
// //         </Card>
// //       )}
...
// //         <Text strong>Total registros: {dataSource.length}</Text>
// //         <div style={{ float: 'right' }}>
// //           <Text>
// //             Activas: <Tag color="green">{totalActivos}</Tag>
// //             Completadas: <Tag color="blue">{dataSource.filter(item => item.estado_asistencia === 'completada').length}</Tag>
// //           </Text>
// //         </div>
// //       </div>
...
//     setFechas(dates);
//     if (dates && validarRangoFechas(dates)) {
//       // Si las fechas son válidas, hacer la búsqueda automáticamente
//       fetchAsistencias(dates);
//     }
//   };

//   const fetchAsistencias = (dates?: [Dayjs, Dayjs] | null) => {
//     if (!dates && !fechas) {
//       // Si no hay fechas seleccionadas, no hacer nada
//       return;
//     }

//     const fechasABuscar = dates || fechas;
    
//     if (!fechasABuscar || !validarRangoFechas(fechasABuscar)) {
//       return;
//     }
...
//       if (fechasABuscar) {
//         const [startDate, endDate] = fechasABuscar;
//         asistenciasFiltradas = asistencias.filter(asistencia => {
//           const fechaIngreso = dayjs(asistencia.fecha_ingreso, 'DD-MM-YYYY');
//           return fechaIngreso.isBetween(startDate, endDate, 'day', '[]');
//         });
//       }

//       setInitialData(asistenciasFiltradas);
//       setDataSource(asistenciasFiltradas);
//       setContratistasStats(calcularActivosPorContratista(asistenciasFiltradas));
//       setLoading(false);
//     }).catch(() => {
//       setLoading(false);
//     });
...
//   // Calcular total de activos
//   const totalActivos = dataSource.filter(item => item.estado_asistencia === 'activa').length;
//   const totalCompletadas = dataSource.filter(item => item.estado_asistencia === 'completada').length;
...
//           <div>
//             <Text strong style={{ marginRight: 8 }}>Seleccionar rango de fechas:</Text>
...
//           {fechaError && (
//             <Alert message={fechaError} type="error" showIcon />
//           )}
//         </Space>
//       </Card>

//       {/* Sección de Estadísticas por Contratista - Mejorada */}
//       {contratistasStats.length > 0 && (
//         <Card 
//           title={
//             <Space>
...
//           <Row gutter={[16, 16]}>
//             {contratistasStats.map((contratista, index) => (
//               <Col xs={24} sm={12} md={8} lg={6} xl={4} key={contratista.nombre}>
//                 <Card 
//                   size="small" 
//                   hoverable
//                   style={{ 
//                     borderLeft: `4px solid ${contratista.totalActivos > 0 ? '#52c41a' : '#ff4d4f'}`,
//                     textAlign: 'center'
//                   }}
//                 >
//                   <Statistic
...
//                     value={contratista.totalActivos}
//                     valueStyle={{ 
//                       color: contratista.totalActivos > 0 ? '#52c41a' : '#d9d9d9',
//                       fontSize: '28px',
//                       fontWeight: 'bold'
//                     }}
//                     suffix={
...
//           <div style={{ marginBottom: 16 }}>
//             <Space size="large">
//               <Text strong>Total registros: <Tag>{dataSource.length}</Tag></Text>
//               <Text>Activas: <Tag color="green">{totalActivos}</Tag></Text>
//               <Text>Completadas: <Tag color="blue">{totalCompletadas}</Tag></Text>
//             </Space>
//           </div>
//         </>
//       )}
...
//               <Text>Seleccione un rango de fechas para ver el reporte</Text>
...
import Table, { ColumnsType } from "antd/es/table";
import { SearchBar } from "@/modules/gestion-empresas/pages/empresas/pages/ListEmpresas/styled";
import { getReporteAsistenciasTH, FiltroReporteAsistencia } from "@/services/talento-humano/reporteAPI";
import dayjs, { Dayjs } from "dayjs";
