...
// // Tipos para los datos de documentos
// interface EtapaData {
//   etapa: number;
//   avance: number;
//   atrazo: number;
...
//       // Guardar solo datos de documentos
//       setTramitesData(tramitesDataResponse.porcentajes);
...
//   // Función para renderizar círculo de documentos con información detallada
//   const renderDocumentosCircle = useCallback(
//     (codigoProyecto: number) => {
//       const documentoData = getDocumentosData(codigoProyecto);

//       // Si NO existe la relación por codigo_proyecto
//       if (!documentoData) {
//         return (
//           <Tooltip title="Sin datos de documentos" placement="top">
//             <div className="circle-progress-container">
//               <div className="circle-progress-wrapper">
//                 <div className="no-data-circle">
//                   <div className="no-data-text">PND</div>
//                 </div>
//               </div>
//               <span className="circle-progress-label">DOCS</span>
//             </div>
//           </Tooltip>
//         );
//       }
...
//         <Tooltip
//           title={
//             <div style={{ textAlign: 'center', padding: '8px', maxWidth: '220px' }}>
//               <div style={{ fontWeight: 'bold', marginBottom: '4px', fontSize: '12px', color: 'black' }}>
//                 Avance de Documentos
//               </div>
//               <div style={{ marginBottom: '3px', fontSize: '11px', color: 'black' }}>
//                 <strong>Total:</strong> {documentoData.completados || 0}/{documentoData.total || 0}
//               </div>
//               <div style={{ marginBottom: '3px', fontSize: '11px', color: 'black' }}>
//                 <strong>Pendientes:</strong> {documentoData.pendientes || 0}
//               </div>
//               <div style={{ marginBottom: '3px', fontSize: '11px', color: 'black' }}>
//                 <strong>Avance:</strong> {documentoData.avance.toFixed(1)}%
//               </div>
//               <div style={{ marginBottom: '3px', fontSize: '11px', color: 'black' }}>
//                 <strong>Atraso:</strong> {documentoData.atrazo.toFixed(1)}%
//               </div>
              
//               {documentoData.etapas && documentoData.etapas.length > 0 && (
//                 <>
//                   <div style={{ margin: '8px 0 4px 0', fontWeight: 'bold', borderTop: '1px solid #e2e8f0', paddingTop: '6px', fontSize: '12px' }}>
//                     Por Etapas:
//                   </div>
//                   {documentoData.etapas.map((etapa, idx) => (
//                     <div key={idx} style={{ fontSize: '11px', color: 'black', marginBottom: '3px' }}>
//                       <strong>Etapa {etapa.etapa}:</strong> {etapa.avance.toFixed(1)}%
...
//       // Agregar los demás botones que todos pueden ver solo ing, admin y directora proyectos
//       if (
//         user_rol === "Administrador" ||
//         user_rol === "Directora Proyectos" ||
//         user_rol === "Ingeniero Obra"
...
//             {/* Documentos - Solo mostramos documentos */}
//             {renderDocumentosCircle(item.codigo_proyecto)}
//           </div>
