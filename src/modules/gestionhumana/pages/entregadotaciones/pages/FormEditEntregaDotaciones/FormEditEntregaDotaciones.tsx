...
import { EditEntregaDotacion } from "../../components/EditEntregaDotacion";
import { getDotaciones, getEntregaDotacion, updateEntregaDotacion } from "@/services/gestion-humana/dotacionesAPI";
...
export const FormEditEntregaDotaciones = () => {
  ...
  const onFinish: SubmitHandler<any> = async (data) => {
    ...
    updateEntregaDotacion(formData, id)
      .then((res) => {
