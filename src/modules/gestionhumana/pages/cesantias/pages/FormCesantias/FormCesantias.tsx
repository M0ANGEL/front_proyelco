...
import { crearCesantia, getCesantia, updateCesantia } from "@/services/gestion-humana/cesantiasAPI";
...
export const FormCesantias = () => {
  ...
  const onFinish: SubmitHandler<any> = async (data) => {
    ...
    if (cesantia) {
      ...
      crearCesantia(data).then(() => {
          pushNotification({ title: "Cesantia creado con exito!" });
          setTimeout(() => {
            navigate(-1);
          }, 800);
        })
    ...
    <>
      ...
      >
        <FormProvider {...control}>
          ...
          >
            <StyledCard
              title={(cesantia ? "Editar" : "Crear") + " Fondo de cesantias"}
              extra={
                <Space>
